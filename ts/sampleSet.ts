...
class SampleSet {
	...
	private static readonly sampleColors = ["#f00","#ff0","#0f0","#0ff","#00f","#f0f","#f00","#ff0","#0f0","#0ff","#00f","#f0f","#f00","#ff0","#0f0","#0ff","#00f","#f0f","#f00","#ff0","#0f0","#0ff","#00f","#f0f","#f00","#ff0","#0f0","#0ff","#00f","#f0f","#f00","#ff0","#0f0","#0ff","#00f","#f0f","#f00","#ff0","#0f0","#0ff","#00f","#f0f","#f00","#ff0","#0f0","#0ff","#00f","#f0f","#f00","#ff0","#0f0","#0ff","#00f","#f0f","#f00","#ff0","#0f0","#0ff","#00f","#f0f"];
